    ...
    >
        <div class="flex w-[75%] items-center gap-x-5">
            ...
            >
                ...
                />
                <h2
                    class="font-Quicksand text-[15px] font-semibold leading-[1.3] text-pageInfoTextColor"
                >
            ...
            >
                ...
                <h2
                    class="font-Quicksand text-[15px] font-semibold leading-[1.3] text-pageInfoTextColor"
                >
                    Save more by returning cashback for each order
                </h2>
            </div>
        </div>
        ...
        >
            ...
            <div class="flex items-center gap-x-2 xl:gap-x-3.5">
                <img
                    src="../../assets/images/navbar/whatsapp.webp"
                    alt="whatsapp"
                />
                <h2>+966 55 80 2 88 55</h2>
            </div>
        </div>
    </div>
</template>
