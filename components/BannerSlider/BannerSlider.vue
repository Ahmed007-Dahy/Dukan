    ...
    >
        ...
        >
            ...
            >
                <div>
                    <h2
                        class="font-Quicksand text-[20px] font-semibold landscape:sm:text-[30px] landscape:lg:text-[56px]"
                    >
                        Flavours of Italy
                    </h2>
                    <p
                        class="text-center font-Quicksand text-[12px] lg:text-[20px]"
                    >
                ...
                <button
                    type="button"
                    class="mt-7 hidden rounded-lg bg-paginationColor px-10 py-3 font-Quicksand text-[20px] font-semibold landscape:lg:inline"
                >
                    Shop Now
                </button>
            </div>
            ...
            />
            <img
                class="absolute left-[-5%] top-0 w-[25%] landscape:md:w-[20%] landscape:lg:left-[2%] landscape:lg:w-auto"
                src="../../assets/images/banners/can.webp"
                alt="bottle"
            />
            <img
            ...
            />
            <img
                class="absolute bottom-[-15%] left-[20%] w-[25%] lg:bottom-[0%] lg:left-[15%] landscape:md:w-[20%] landscape:lg:w-auto"
                src="../../assets/images/banners/pasta2.webp"
                alt="bottle"
            />
            <img
                class="absolute bottom-[-7%] left-[4%] w-[25%] -rotate-12 lg:bottom-0 lg:left-[0] tablet:w-[20%] landscape:lg:w-auto"
                src="../../assets/images/banners/spaghetti.webp"
                alt="bottle"
            />
        </div>
    </section>
