...
async function fetchNewProducts() {
    try {
        ...
        const categoryData = data.filter(
            (item) => item.type === "most_popular_products",
        );
...
<template>
    <main class="relative min-h-[20px] max-w-full">
        ...
        <button
            ...
            } swiper-next-slide-most-products absolute right-[9%] top-[0.5%] md:right-[4.2%] tablet:top-[0%]`"
            type="button"
        >
            <Icon
                class="text-2xl"
        ...
        <Swiper
            class="h-auto max-w-full pl-32"
            :modules="[SwiperAutoplay, SwiperFreeMode, SwiperNavigation]"
            :breakpoints="swiperConfig.breakpoints"
            :loop="true"
            :effect="'coverflow'"
            :navigation="{
                nextEl: '.swiper-next-slide-most-products',
                prevEl: '.swiper-perv-slide-most-products',
            }"
            :autoplay="{
                delay: 4000,
        ...
        <button
            ...
            :class="`${
                toggleActiveButton === 'btn2'
                    ? 'border-2 border-banner'
                    : 'border-2 border-gray-500'
            } } swiper-perv-slide-most-products  absolute right-[0%] top-[0.5%] tablet:right-[1.5%] tablet:top-[0%]`"
            type="button"
        >
            <Icon
                class="text-2xl"
